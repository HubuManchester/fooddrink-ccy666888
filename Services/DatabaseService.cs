...
namespace TasteHub.Services
{
    ...
    public class DatabaseService : IDatabaseService
    {
        ...
        /// <summary>
        /// Insert sample recipes so the app is not empty on first launch
        /// </summary>
        private async Task SeedSampleDataAsync()
        {
            var sampleRecipes = new List<Recipe>
            {
                ...
                new Recipe
                {
                    ...
                    Steps = "[\"Preheat oven to 180°C\",\"Melt chocolate and butter together\",\"Whisk eggs and sugar until fluffy\",\"Fold in the chocolate mixture\",\"Sift in flour and cocoa powder, fold gently\",\"Pour into a lined baking tin and bake for 25 minutes\"]",
